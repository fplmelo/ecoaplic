...
::::{.columns} :::{.column width="50%"} ![](https://www.fao.org/fileadmin/user_upload/faoweb/plant-treaty/images/medium_Darwin-logo.jpg){width=300}

:::

:::{.column width="50%"} The Darwin Initiative is a UK government grants scheme that helps to protect biodiversity and the natural environment through \[locally based projects\]{style="color: red;"} worldwide.
...
::::{.columns} :::{.column width="50%"} ![](libs/dar_proj.png){width=500}
...
::::{.columns} :::{.column width="50%"} ![](https://www.lebow.drexel.edu/sites/default/files/legacy/story/1501077931-network.jpg){width=600}
...
:::{.column width="50%"} ![](libs/biocult-core.jpg){width=700} ::: ::::
...
:::{.column width="50%"} :::{.fragment} :::{.nonincremental} Testing diversity-functioning
...
:::{.fragment} :::{.nonincremental} ::::{.columns} :::{.column width="50%"} ![](libs/ranksp.png)
...
:::{.nonincremental} ::::{.columns} :::{.column width="50%"} ![](libs/climate_kenya.png)
...
::::{.columns} :::{.column width="50%"} ![](libs/design.jpeg){width=350} ::: :::{.column width="50%"}
...
::::{.columns} :::{.column width="50%"} ![](libs/bef_prev.png){width=700} :::
...
::::{.columns} :::{.column width="50%"} ![](libs/seedcol.jpg){width=700} :::
...
::::{.columns} :::{.column width="50%"} ![](libs/comm_net.jpg){width=700} :::
