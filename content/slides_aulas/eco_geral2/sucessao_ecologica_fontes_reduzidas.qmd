...
format:
  revealjs:
    ...
    logo: ""
    footer: "Sucessão Ecológica | Biomas Brasileiros"
    css: styles.css
    chalkboard: false
    incremental: false
    fig-align: center
...
# Módulo 3 {background-color="#1b5e20"}
...
| Bank de sementes | Ausente | Presente |
...
# Módulo 4 {background-color="#1b5e20"}

## Distúrbio e Sucessão Ecológica
...
::: {.destaque}
**Distúrbio** (Pickett & White, 1985): evento discreto no tempo que perturba a estrutura de ecossistemas, comunidades ou populações e altera recursos, disponibilidade de substrato ou ambiente físico.
:::
...
- Retarda ou impede sucessão secundária por:
  ...
  - "Savaneização" com gramíneas exóticas

**Consequência:** em ~40% das áreas desmatadas, a floresta secundária **não consegue se reestabelecer** sem intervenção ativa de restauração.
</div>
</div>
...
**Dinâmica de clareira na Amazônia:**
1. Queda → explosão de luz no sub-bosque
2. *Cecropia*, *Heliconia*, cipós colonizam (< 1 ano)
3. Árvores secundárias fecham (2–5 anos)
4. Espécies tolerantes à sombra recrutam (5–20 anos)
</div>
<div>
...
# Módulo 5 {background-color="#1b5e20"}

## Ecologia Funcional e Sucessão
...
**Na Mata Atlântica:**
- Pioneiras (*Cecropia*): SLA ~ 25 m²/kg, madeira ~0,3 g/cm³
- Tardias (*Cariniana*): SLA ~10 m²/kg, madeira ~0,75 g/cm³
...
# Módulo 6 {background-color="#1b5e20"}

## Sucessão nos Biomas Brasileiros

---

## Biomas do Brasil — Contexto

<div class="grid-2">
<div>

O Brasil abriga **6 biomas terrestres** reconhecidos oficialmente pelo IBGE, além de ecossistemas costeiros e aquáticos.

| Bioma | Área (km²) | % Brasil |
|-------|-----------|---------|
| Amazônia | 4.196.943 | ~49% |
| Cerrado | 2.036.448 | ~24% |
...
<div class="card-dark">
<h4>🌿 Por que os biomas brasileiros são únicos para estudar sucessão?</h4>

- **Megadiversidade:** 15–20% da biodiversidade mundial
- **Gradientes climáticos** extremos (hiper-úmido → semi-árido)
- **Perturbações naturais** diversas (fogo, inundação, seca)
- **Histórico humano** de uso e degradação
- **Endemismo alto** → espécies com estratégias únicas
- Laboratório natural para testar teorias ecológicas
</div>
</div>
...
- Floresta de **alta resiliência** quando banco de sementes intacto
- Diversidade arbórea: 300–600 spp./ha → sucessão altamente variável
- **Capoeiras** (florestas secundárias) são abundantes e ecologicamente importantes
- Síndrome de dispersão zoocórica dominante → dependência de fauna

**Sequência típica pós-corte:**
1. Gramíneas e *Cecropia* (0–3 anos)
2. Dossel de pioneiras (3–10 anos)
3. Sub-bosque diversificado (10–25 anos)
4. Floresta secundária madura (25–80 anos)
5. Convergência com floresta primária (80–200 anos+)
</div>
<div>

::: {.destaque}
**"Floresta degradada vs. floresta secundária"**

Após desmatamento com maquinário pesado, degradação de solo e invasão por *Urochloa brizantha* (braquiária), muitas áreas entram em **sucessão travada** — sem intervenção ativa, permanecem como vegetação degradada por décadas.
:::

**Traços-chave de pioneiras amazônicas:**
- *Cecropia* spp. — SLA alto, crescimento rápido, N-fixação via simbiose com *Azteca*
- *Vismia* spp. — colonizadoras de solos compactados
- *Inga* spp. — leguminosas facilitadoras de nitrogênio
</div>
</div>
...
**O Cerrado é uma savana-floresta pirofítica:**

- Fogo como **agente estruturador primário** (natural e manejado)
- Gradiente fisionômico: campo limpo → campo cerrado → cerradão
- **Estrutura subterrânea** (glomérulos, xilopódios) como legado de sucessão

**Após fogo:** 
- Rebrota de espécies lenhosas via órgãos subterrâneos (semanas)
- Germinação de herbáceas (primeira chuva)
- Recuperação de cobertura arbórea (3–5 anos)
- Biomassa pré-fogo restaurada (5–10 anos)

</div>
<div class="card-dark">
<h4>🔥 Gradiente fisionômico e fogo</h4>

```
Campo limpo ←──── mais fogo ──────
        ↑
Campo cerrado   ← fogo intermediário
        ↑
Cerrado s.s.    ← fogo moderado
        ↑
Cerradão        ← pouco/sem fogo
        ↑
Mata de galeria ← sem fogo (ripária)
```

A **ausência total de fogo** por décadas converte campos em cerradão — mas reduz diversidade de herbáceas.
...
## Sucessão na Mata Atlântica

<div class="grid-2">
<div>

**Bioma altamente fragmentado (< 12% remanescente):**

- Extensão latitudinal enorme → diversidade de regimes climáticos
- **Alta taxa de endemismo** torna a sucessão crítica para conservação
- Restauração ativa é amplamente praticada

**Fatores moduladores da sucessão:**
- Tamanho do fragmento de origem
- Disponibilidade de dispersores (aves, morcegos)
- Uso anterior do solo (pastagem vs. agricultura)
- Conectividade da paisagem

</div>
<div>

**Espécies-chave em cada fase:**

| Fase | Espécie | Papel |
|------|---------|-------|
| Pioneira | *Cecropia glaziovii* | Dossel inicial, abrigo |
| Pioneira | *Trema micrantha* | Enriquecimento do solo |
| Inicial | *Schizolobium parahyba* | Biomassa rápida |
| Intermediária | *Inga marginata* | Facilitação N |
| Tardia | *Euterpe edulis* | Sub-bosque denso |
| Tardia | *Cariniana legalis* | Emergente maduro |
...
## Sucessão na Caatinga

<div class="grid-2">
<div>

**Bioma com dinâmica guiada pela seca:**

- Regime hídrico **altamente sazonal e imprevisível** (ENSO)
- Vegetação caducifólia: folhas como mecanismo de tolerância ao estresse
- **Banco de sementes persistente** — fundamental para regeneração pós-seca

**Após abandono de áreas agrícolas:**
1. *Mimosa tenuiflora* (jurema-preta) coloniza rapidamente
2. Cactos e bromélias estabelecem-se em 5–10 anos
3. Diversificação lenta com espécies de maior porte (10–30 anos)
4. *Schinopsis brasiliensis* (braúna), *Amburana cearensis* — tardias

</div>
<div class="card-dark">
<h4>💧 Seca como filtro funcional</h4>

Traços selecionados positivamente na Caatinga:

- **CAM** e suculência (*Cereus*, *Opuntia*)
- **Caducifolia** — queda foliar antes da estação seca
- **Raízes dimórficas** — superficiais (chuva) + profundas (reserva)
- **Sementes dormentes** que aguardam condições ideais
- **Rebrotamento de cepas** — *Mimosa*, *Cnidoscolus*

A sucessão na Caatinga é **mais lenta e menos previsível** que em biomas mais úmidos.
</div>
</div>

---

## Sucessão no Pantanal

<div class="grid-2">
<div>

**O pulso de inundação como motor sucessional:**

- Inundação sazonal: 3–7 meses/ano em algumas sub-regiões
- Cria **gradiente topográfico-hidrológico** que determina fisionomias
- **Não é uma sucessão linear** — é um ciclo anual de reorganização

**Gradiente inundação → terra firme:**

```
Lagoa → Macrófitas flutuantes
      → Vegetação aquática emergente
      → Campo úmido (inundado 6+ meses)
      → Campo sazonal (inundado 2–4 meses)
      → Cerrado sazonalmente inundado
      → Cerradão de terra firme
```
...
::: {.destaque}
**Camalotal** (*Eichhornia* spp., *Pontederia* spp.) é a unidade de sucessão aquática mais dinâmica do Pantanal — ciclos anuais completos de colonização, crescimento e decomposição.
:::

**Espécies-chave:**
- *Vochysia divergens* (cambará) — invasora de campos após perturbação hidrológica; indica mudanças no regime de inundação
- *Hymenachne amplexicaulis* — gramínea de campos inundáveis, colonizadora eficiente
- *Inga vera* — facilitadora em matas ciliares ripárias
</div>
</div>
...
**Campo subtropical com longa história de pastejo:**

- Bioma dominado por **gramíneas C3 e C4** com estrato herbáceo diverso
- Distúrbios históricos: pastejo de ungulados nativos (hoje bovinos), geada, granizo
- **Poucos estudos** sobre sucessão primária no Pampa

**Dinâmica sucessional:**
- Campos degradados por pastejo excessivo → dominância de *Andropogon lateralis* e *Paspalum* spp.
- Exclusão do pastejo → aumento de lenhosas (*Baccharis*, *Eryngium*)
- Invasão de *Urochloa humidicola* em áreas úmidas

</div>
<div class="card-dark">
<h4>🐄 Pastejo como distúrbio modulador</h4>

No Pampa gaúcho, o pastejo controlado **mantém a diversidade de gramíneas**:

- Pastejo moderado → diversidade alta (análogo à HDI)
- Superpastejo → invasoras dominam, solo compactado
- Exclusão total → arbustificação com *Baccharis trimera*

→ **"Campos sem manejo se fecham"** — contrariando a intuição conservacionista, a biodiversidade campestre pode diminuir sem pastejo racional.
...
## Síntese: Teoria e Padrões Brasileiros
...
A teoria dos **estados alternativos estáveis** (Scheffer et al. 2001) é central para entender os biomas brasileiros sob pressão:

**Floresta ↔ Savana** (Amazônia)
- Floresta: mantida por reciclagem de chuva e feedback evapotranspiratório
- Savana: se desmatamento + seca rompem o ciclo hidrológico

**Cerrado ↔ Campo degradado**
- Fogo frequente + invasoras gramíneas → estado alternativo de baixa biomassa lenhosa

Transições são **abruptas e difíceis de reverter**.
</div>
</div>
...
<div style="font-size: 0.78em; column-count: 2; column-gap: 2em;">
...
- MacArthur & Wilson (1967). *The Theory of Island Biogeography*. Princeton UP.
- Grime, J.P. (1977). Evidence for the existence of three primary strategies in plants. *American Naturalist* 111:1169–1194.
- Connell, J.H. & Slatyer, R.O. (1977). Mechanisms of succession. *American Naturalist* 111:1119–1144.
- Connell, J.H. (1978). Diversity in tropical rain forests and coral reefs. *Science* 199:1302–1310.

**Funcionais e modernas:**
- Díaz, S. et al. (2016). The global spectrum of plant form and function. *Nature* 529:167–171.
- Westoby, M. et al. (2002). Plant ecological strategies. *Annual Review of Ecology and Systematics* 33:125–159.
- Scheffer, M. et al. (2001). Catastrophic shifts in ecosystems. *Nature* 413:591–596.

**Biomas brasileiros:**
- Oliveira-Filho, A.T. & Fontes, M.A.L. (2000). Patterns of floristic differentiation among Atlantic Forests. *Biotropica* 32:793–810.
- Hoffmann, W.A. et al. (2012). Ecological thresholds at the savanna-forest boundary. *Ecology Letters* 15:759–768.
- Neri, A.V. et al. (2012). Diversidade de estratégias de regeneração no Cerrado. *Acta Botanica Brasilica*.
- Melo, F.P.L. et al. (2013). Priority setting for scaling up tropical forest restoration. *Biological Conservation* 163:98–107.
...
<div style="color:#a5d6a7; margin-top:1em;">
Da teoria de Clements e Gleason às fronteiras da ecologia funcional — o Brasil como laboratório natural para entender a dinâmica da vida.
</div>
